<%@page import="com.action.bean.ActionBean,com.entity.Classify,com.entity.Article,com.tool.Convert"%>
...
Map resultMap=actionBean.queryArticleMapEdit(article_id);
List<Classify> list=(List)resultMap.get("classifyList");
    ...
    <jsp:include page="left.jsp"></jsp:include>
      <div class="right">
        <div class="admin">
         ...
         <input name="article_id" id="article_id" value="<%=article.getArticle_id()%>" type="hidden">
    	<table >
    		<tr>
    		   <td>新闻标题</td>
    		     <td>
    		      <input id="article_title" name="article_title"  maxlength="300" autocomplete="off"  value="<%=article.getArticle_title() %>" />
    		    </td>
    		...
    		<tr><td>新闻类别</td><td>
    			<select id="classify_id" name="classify_id">
    				...
    				<% 
    			     ...
    			     %>
    					 <option <%=classify.getClassify_id().equals(article.getClassify_id())?"selected ='selected' ":""  %> value="<%=classify.getClassify_id()%>"><%=classify.getClassify_name()%> </option>
    					  <% 
    					}
    				 %>
    			</select>
    		...
    		<tr><td>发布时间</td>
    		   <td><input id="article_date" name="article_date"  maxlength="20" autocomplete="off" type="date" value="<%=article.getArticle_date()%>"/></td>
    		   <td id="err_article_date"></td>
    		</tr>
    		<tr>
    			<td valign="top">新闻正文</td>
    			<td colspan="2">
    				<textarea name="content1" rows="" cols="" style="width:700px;height:400px;"><%=Convert.htmlspecialchars(article.getArticle_content())%></textarea>
    			</td>
    		</tr>
    		<tr>
