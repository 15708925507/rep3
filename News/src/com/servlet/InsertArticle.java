...
public class InsertArticle extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( article_title ==null || article_date ==null || classify_id ==null){
			...
			out.println("  <BODY>");
			out.print("    输入信息不万整请重新输入。<a href=\"addArticle.jsp\">返回重新输入</a>");
		...
		boolean b= sqlHelper.insertArticle(article);
		sqlHelper.destory();
		if(!b){
			response.setCharacterEncoding("utf-8");
			response.setContentType("text/html");
			...
			out.println("  <HEAD><TITLE></TITLE></HEAD>");
			out.println("  <BODY>");
			out.print("    增加错误。<a href=\"addArticle.jsp\">返回重新输入</a>");
